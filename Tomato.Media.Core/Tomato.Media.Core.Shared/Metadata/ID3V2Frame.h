...
public:
	...
	///<summary>读取帧</summary>
	static ID3V2FrameKind ReadFrame(BinaryReader& reader, const std::function<bool(const ID3V2FrameKind&)>& framePredicate, std::unique_ptr<ID3V2Frame>& frame);
protected:
	virtual void ReadContent(BinaryReader&& reader) = 0;
protected:
